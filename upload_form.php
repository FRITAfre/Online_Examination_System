...
<body>
  <header id="header">
    <div class="row">
      <i class="bi bi-book">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" class="bi bi-book"
          viewBox="0 0 16 16">
          <path
      ...
      <h3 class="topic">Upload Resource</h3>
          ...
          <div class="form-row">
            ...
            <div class="form-row col-lg-4">
              <div class="mb-3">
                ...
                <input class="form-control" type="file" id="formFile" name="myfile" autocomplete="off">
              </div>
            </div>
            <div class="form-row col-lg-4">
